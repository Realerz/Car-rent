...
namespace SADProject1
{
    public partial class newCus : Form
    {
        ...
        private void Button4_Click(object sender, EventArgs e)
        {
            if (Rmale.Checked)
            {
                label9.Text = Rmale.Text;
            }
            else if (Rfemale.Checked)
            {
                label9.Text = Rfemale.Text;
            }
            ...
            else
            {
                ...
                con.Open();
                cmd = new SqlCommand("INSERT INTO CusList(cusID,Name,BirthDay,Tel,Email,Gender,Nationality,Address,Province,City,Postal) VALUES (@cusID,@Name,@BirthDay,@Tel,@Email,@Gender,@Nationality,@Address,@Province,@City,@Postal)", con);
                cmd.Parameters.Add("@cusID", txtID.Text);
                cmd.Parameters.Add("@Name", txtName.Text);
                cmd.Parameters.Add("@BirthDay", DTBirth.Text);
                cmd.Parameters.Add("@Tel", txtTel.Text);
                cmd.Parameters.Add("@Email", txtEmail.Text);
                cmd.Parameters.Add("@Gender", label9.Text);
